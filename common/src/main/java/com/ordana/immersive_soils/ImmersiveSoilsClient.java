...
public class ImmersiveSoilsClient {
    
    public static void init() {
        ClientHelper.addClientSetup(ImmersiveSoilsClient::setup);
        ClientHelper.addBlockColorsRegistration(ImmersiveSoilsClient::registerBlockColors);
        ClientHelper.addItemColorsRegistration(ImmersiveSoilsClient::registerItemColors);
    }
